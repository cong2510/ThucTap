...
--
-- Host: 127.0.0.1:3306
-- Generation Time: Mar 27, 2023 at 09:22 PM
...
INSERT INTO `phim` (`IDPhim`, `IDTheLoai`, `TenPhim`, `ThoiLuong`, `KhoiChieu`, `Mota`, `Img`) VALUES
...
(2, 1, 'HOW TO SAVE THE IMMORTAL', '76 phút', '2023-03-14', 'Hành trình đi tìm tình yêu cùa hoàng tử đẹp trai và bất tử Koschey,nhưng vẫn không ai đồng ý mặc dù anh đã nhiều lần bắt cóc và biến nhiều công chúa thành ếch.Sau đó anh gặp nữ anh hùng Varvara, liệu sự chân thành của anh ta có chinh phục được cô ấy ?', 'cuocchienbattu.jpg'),
...
(4, 4, 'THE ONE', '96 phút', '2023-03-11', 'Cặp vợ chồng mới cưới Larisa và Vladimir trở về nhà từ tuần trăng mật ở Blagoveshchensk và bị va chạm máy bay, Larisa phải vật lộn với cái đói cái lạnh và động vật hoang dã săn mồi. Liệu Larisa có tìm được vị hôn phu và cùng sống sót trở về ?', 'songsot.jpg'),
(5, 4, 'SOULMATE', '124 phút', '2023-03-16', 'Mi So và Ha Eun trong một mối quan hệ chồng chéo chất chứa những hạnh phúc, rung động và biệt ly. Từ giây phút gặp nhau , hai cô gái đã hình thành sợi dây liên kết đặc biệt nhưng mối quan hệ của họ rạn nứt khi một chàng trai xuất hiện...', 'soulmate.jpg'),
(6, 2, 'THE COMUNION GIRL', '99 phút', '2023-03-10', 'Dựa trên truyền thuyết đô thị rùng rợn về một hồn ma cô gái mặc phục trang cho buổi Rước lễ lần đầu. Sara và bạn thân Rebe phải đối mặt với sự truy đuổi ác nghiệt từ một linh hồn không tên, cả hai sẽ phải làm gì để bảo vệ bản thân và gia đình...?', 'vonghon.jpg'),
(7, 6, 'NHỮNG ĐỨA TRẺ TRONG SƯƠNG', '93 phút', '2023-03-04', 'Di, một cô gái trẻ nhiệt huyết đến từ cộng đồng người Mông bị mắc kẹt giữa truyền thống \"kéo vợ\" và mong muốn được tiếp tục sống thời thơ ấu và đến trường đi học , liệu với trái tim trong sáng ấy , Di sẽ đối diện với xã hội ấy như thế nào...?', 'nhungduatretrongsuong.jpg'),
(8, 4, 'MY BEAUTIFUL MAN MOVIE: SPECIAL EDITION', '98 phút', '2023-03-31', 'Hira, 17 tuổi, cố gắng ẩn mình ở trường, không bao giờ muốn phơi bày tật nói lắp của mình với các bạn cùng lớp. Anh ấy nhìn thế giới qua ống kính máy ảnh của mình, cho đến một ngày Kiyoi Sou bước qua cửa lớp...', 'mybeautifulman.jpg');
